    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <form  method="post">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" name="txt-name" id="txt-name" value="<?= $cate_data[0]->name ?>" require>
            </div>
            <div class="form-group">
                <label>Order</label>
                <input type="number" min="0" class="form-control" name="txt-od" id="txt-od" value="<?= $cate_data[0]->od ?>" require>
            </div>
            <div class="form-group">
                <label>Status</label>
