        ...
        ?>
            <tr>
                <tbody>
                    ...
                    <td>
                        <img src="<?php echo $BASE_URL; ?>/public/img/upload/news/<?= $val->img ?>" alt="<?= $val->img ?>" onerror="this.src='/public/img/default/bg_gallery.png'" width="60" height="60" style="margin-top: -12px;">
                    </td>
                    <td>
